...
\DoxyCodeLine{278   servo\_mode\_t mode;  \textcolor{comment}{/* turning mode of servomotor, refer to type servo\_mode\_t                */}}
\DoxyCodeLine{279   servo\_status\_t dir; \textcolor{comment}{/* current turning direction of servomotor, refer to type servo\_status\_t */}}
\DoxyCodeLine{280   \textcolor{keywordtype}{float} speed;        \textcolor{comment}{/* motor shaft turning speed                                             */}}
\DoxyCodeLine{281 \} \mbox{\hyperlink{structcontrol_1_1servo__jam__t}{servo\_jam\_t}};}
\DoxyCodeLine{282 }
\DoxyCodeLine{283 \textcolor{keyword}{class }\mbox{\hyperlink{classcontrol_1_1ServoMotor}{ServoMotor}};  \textcolor{comment}{// declare first for jam\_callback\_t to have correct param type}}
\DoxyCodeLine{287 \textcolor{comment}{}\textcolor{keyword}{typedef} void (*jam\_callback\_t)(\mbox{\hyperlink{classcontrol_1_1ServoMotor}{ServoMotor}}* servo, \textcolor{keyword}{const} \mbox{\hyperlink{structcontrol_1_1servo__jam__t}{servo\_jam\_t}} data);}
\DoxyCodeLine{288 }
\DoxyCodeLine{292 \textcolor{keyword}{typedef} \textcolor{keyword}{struct }\{}
\DoxyCodeLine{293   \mbox{\hyperlink{classcontrol_1_1MotorCANBase}{MotorCANBase}}* motor;      \textcolor{comment}{/* motor instance to be wrapped as a servomotor     */}}
\DoxyCodeLine{294   servo\_mode\_t mode;        \textcolor{comment}{/* mode of turning, refer to type servo\_mode\_t      */}}
\DoxyCodeLine{295   \textcolor{keywordtype}{float} speed;              \textcolor{comment}{/* desired turning speed of motor shaft, in [rad/s] */}}
\DoxyCodeLine{296   \textcolor{keywordtype}{float} transmission\_ratio; \textcolor{comment}{/* transmission ratio of motor                      */}}
\DoxyCodeLine{297   \textcolor{keywordtype}{float} move\_Kp;            \textcolor{comment}{/* Kp of pid that used to control omega             */}}
\DoxyCodeLine{298   \textcolor{keywordtype}{float} move\_Ki;            \textcolor{comment}{/* Ki of pid that used to control omega             */}}
\DoxyCodeLine{299   \textcolor{keywordtype}{float} move\_Kd;            \textcolor{comment}{/* Kd of pid that used to control omega             */}}
\DoxyCodeLine{300   \textcolor{keywordtype}{float} hold\_Kp;            \textcolor{comment}{/* Kp of pid that used to control theta             */}}
\DoxyCodeLine{301   \textcolor{keywordtype}{float} hold\_Ki;            \textcolor{comment}{/* Ki of pid that used to control theta             */}}
\DoxyCodeLine{302   \textcolor{keywordtype}{float} hold\_Kd;            \textcolor{comment}{/* Kd of pid that used to control theta             */}}
\DoxyCodeLine{303 \} \mbox{\hyperlink{structcontrol_1_1servo__t}{servo\_t}};}
\DoxyCodeLine{304 }
\DoxyCodeLine{311 \textcolor{keyword}{class }\mbox{\hyperlink{classcontrol_1_1ServoMotor}{ServoMotor}} \{}
...
\DoxyCodeLine{321 }
\DoxyCodeLine{332   servo\_status\_t \mbox{\hyperlink{classcontrol_1_1ServoMotor_a8816253f442fabd9ec2af3873e8f0372}{SetTarget}}(\textcolor{keyword}{const} \textcolor{keywordtype}{float} target, \textcolor{keywordtype}{bool} \textcolor{keyword}{override} = \textcolor{keyword}{false});}
\DoxyCodeLine{333 }
\DoxyCodeLine{345   servo\_status\_t \mbox{\hyperlink{classcontrol_1_1ServoMotor_a8816253f442fabd9ec2af3873e8f0372}{SetTarget}}(\textcolor{keyword}{const} \textcolor{keywordtype}{float} target, \textcolor{keyword}{const} servo\_mode\_t mode, \textcolor{keywordtype}{bool} \textcolor{keyword}{override} = \textcolor{keyword}{false});}
\DoxyCodeLine{346 }
\DoxyCodeLine{353   \textcolor{keywordtype}{void} \mbox{\hyperlink{classcontrol_1_1ServoMotor_aef3f0f32dfc4fca3d1c8c68ba2706f84}{SetSpeed}}(\textcolor{keyword}{const} \textcolor{keywordtype}{float} speed);}
\DoxyCodeLine{354 }
\DoxyCodeLine{359   \textcolor{keywordtype}{void} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a50cef52187514938743ec0ce0331bbcb}{CalcOutput}}();}
\DoxyCodeLine{360 }
\DoxyCodeLine{367   \textcolor{keywordtype}{bool} \mbox{\hyperlink{classcontrol_1_1ServoMotor_ae2e2246e02510eab6d567e1891866791}{Holding}}() \textcolor{keyword}{const};}
\DoxyCodeLine{368 }
\DoxyCodeLine{374   \textcolor{keywordtype}{float} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a2fb7226011f25b56752d16a352ab7122}{GetTarget}}() \textcolor{keyword}{const};}
\DoxyCodeLine{375 }
\DoxyCodeLine{390   \textcolor{keywordtype}{void} \mbox{\hyperlink{classcontrol_1_1ServoMotor_aa23d0cec8d18633aa2d5f09ab0e66d97}{RegisterJamCallback}}(jam\_callback\_t callback, \textcolor{keywordtype}{float} effort\_threshold,}
\DoxyCodeLine{391                            uint8\_t detect\_period = 50);}
\DoxyCodeLine{392 }
\DoxyCodeLine{396   \textcolor{keywordtype}{void} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a6a7ed43abf57b635007052c407ed8675}{PrintData}}() \textcolor{keyword}{const};}
\DoxyCodeLine{397 }
\DoxyCodeLine{403   \textcolor{keywordtype}{float} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a9cf673e64e68a6a6ba5961bed76da345}{GetTheta}}() \textcolor{keyword}{const};}
\DoxyCodeLine{404 }
\DoxyCodeLine{412   \textcolor{keywordtype}{float} \mbox{\hyperlink{classcontrol_1_1ServoMotor_afc2db2da18b05b4aa1ade9de551522a8}{GetThetaDelta}}(\textcolor{keyword}{const} \textcolor{keywordtype}{float} target) \textcolor{keyword}{const};}
\DoxyCodeLine{413 }
\DoxyCodeLine{419   \textcolor{keywordtype}{float} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a7540691d653b6f56bb0fd75d8af1cdfc}{GetOmega}}() \textcolor{keyword}{const};}
\DoxyCodeLine{420 }
\DoxyCodeLine{428   \textcolor{keywordtype}{float} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a9e68a9777cb9686eb8c7d1c2f9980c9b}{GetOmegaDelta}}(\textcolor{keyword}{const} \textcolor{keywordtype}{float} target) \textcolor{keyword}{const};}
\DoxyCodeLine{429 }
\DoxyCodeLine{436   \textcolor{keywordtype}{void} \mbox{\hyperlink{classcontrol_1_1ServoMotor_a28ad384bb271e5043fa922eb8df36779}{UpdateData}}(\textcolor{keyword}{const} uint8\_t data[]);}
\DoxyCodeLine{437 }
\DoxyCodeLine{438  \textcolor{keyword}{private}:}
\DoxyCodeLine{439   \textcolor{comment}{// refer to servo\_t for details}}
\DoxyCodeLine{440   \mbox{\hyperlink{classcontrol_1_1MotorCANBase}{MotorCANBase}}* motor\_;}
\DoxyCodeLine{441   servo\_mode\_t mode\_;}
\DoxyCodeLine{442   \textcolor{keywordtype}{float} speed\_;}
\DoxyCodeLine{443   \textcolor{keywordtype}{float} transmission\_ratio\_;}
\DoxyCodeLine{444   \textcolor{keywordtype}{float} proximity\_;}
\DoxyCodeLine{445 }
\DoxyCodeLine{446   \textcolor{comment}{// angle control}}
\DoxyCodeLine{447   \textcolor{keywordtype}{bool} hold\_;          \textcolor{comment}{/* true if motor is holding now, otherwise moving now                      */}}
\DoxyCodeLine{448   \textcolor{keywordtype}{float} target\_;       \textcolor{comment}{/* desired target angle, range between [0, 2PI] in [rad]                   */}}
\DoxyCodeLine{449   \textcolor{keywordtype}{float} align\_angle\_;  \textcolor{comment}{/* motor angle when a instance of this class is created with that motor    */}}
\DoxyCodeLine{450   \textcolor{keywordtype}{float} motor\_angle\_;  \textcolor{comment}{/* current motor angle in [rad], with align\_angle subtracted               */}}
\DoxyCodeLine{451   \textcolor{keywordtype}{float} offset\_angle\_; \textcolor{comment}{/* cumulative offset angle of motor shaft, range between [0, 2PI] in [rad] */}}
\DoxyCodeLine{452   \textcolor{keywordtype}{float} servo\_angle\_;  \textcolor{comment}{/* current angle of motor shaft, range between [0, 2PI] in [rad]           */}}
\DoxyCodeLine{453   servo\_status\_t dir\_; \textcolor{comment}{/* current moving direction of motor (and motor shaft)                     */}}
\DoxyCodeLine{454 }
\DoxyCodeLine{455   \textcolor{comment}{// jam detection}}
\DoxyCodeLine{456   jam\_callback\_t jam\_callback\_; \textcolor{comment}{/* callback function that will be invoked if motor jammed */}}
\DoxyCodeLine{457   \textcolor{keywordtype}{int} detect\_head\_;     \textcolor{comment}{/* circular buffer current head                                       */}}
\DoxyCodeLine{458   \textcolor{keywordtype}{int} detect\_period\_;   \textcolor{comment}{/* circular buffer length                                             */}}
\DoxyCodeLine{459   \textcolor{keywordtype}{int} detect\_total\_;    \textcolor{comment}{/* rolling sum of motor inputs                                        */}}
\DoxyCodeLine{460   \textcolor{keywordtype}{int} jam\_threshold\_;   \textcolor{comment}{/* threshold for rolling sum for the motor to be considered as jammed */}}
\DoxyCodeLine{461   int16\_t* detect\_buf\_; \textcolor{comment}{/* circular buffer                                                    */}}
\DoxyCodeLine{462 }
\DoxyCodeLine{463   \textcolor{comment}{// pid controllers}}
\DoxyCodeLine{464   \mbox{\hyperlink{classcontrol_1_1PIDController}{PIDController}} move\_pid\_; \textcolor{comment}{/* pid for motor when it is in moving state  */}}
\DoxyCodeLine{465   \mbox{\hyperlink{classcontrol_1_1PIDController}{PIDController}} hold\_pid\_; \textcolor{comment}{/* pid for motor when it is in holding state */}}
\DoxyCodeLine{466 }
\DoxyCodeLine{467   \textcolor{comment}{// edge detectors}}
\DoxyCodeLine{468   \mbox{\hyperlink{classFloatEdgeDetector}{FloatEdgeDetector}}* wrap\_detector\_; \textcolor{comment}{/* detect motor motion across encoder boarder               */}}
\DoxyCodeLine{469   \mbox{\hyperlink{classBoolEdgeDetector}{BoolEdgeDetector}}* hold\_detector\_;  \textcolor{comment}{/* detect motor is in mode toggling, reset pid accordingly  */}}
\DoxyCodeLine{470   \mbox{\hyperlink{classBoolEdgeDetector}{BoolEdgeDetector}}* jam\_detector\_;   \textcolor{comment}{/* detect motor jam toggling, call jam callback accordingly */}}
\DoxyCodeLine{471 }
\DoxyCodeLine{476   \textcolor{keywordtype}{void} NearestModeSetDir\_();}
\DoxyCodeLine{477 }
\DoxyCodeLine{483   \textcolor{keywordtype}{void} SetDirUsingMode\_(servo\_mode\_t mode);}
\DoxyCodeLine{484 \};}
\DoxyCodeLine{485 }
\DoxyCodeLine{486 \} \textcolor{comment}{/* namespace control */}}
